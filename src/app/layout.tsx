...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="id"><body className={jakarta.variable}><DisplayPreferencesProvider><AuthGate>{children}</AuthGate></DisplayPreferencesProvider></body></html>}
